...
pluralCaseList.push( {plural: "chattings", pascal: "Chatting"} )

pluralCaseList.push( {plural: "lectures", pascal: "Lecture"} )

pluralCaseList.push( {plural: "groups", pascal: "Group"} )

pluralCaseList.push( {plural: "authUserInfos", pascal: "AuthUserInfo"} )

pluralCaseList.push( {plural: "recommendUserInfos", pascal: "RecommendUserInfo"} )

pluralCaseList.push( {plural: "hobbyInfos", pascal: "HobbyInfo"} )
